...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ITEMVENDA_LIST actions', async () => {
    ...
    it('dispatches FETCH_ITEMVENDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ITEMVENDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ITEMVENDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ITEMVENDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ITEMVENDA actions', async () => {
      const expectedActions = [
        {
