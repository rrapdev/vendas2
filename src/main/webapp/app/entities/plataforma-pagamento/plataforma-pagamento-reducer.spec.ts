...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './plataforma-pagamento.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLATAFORMAPAGAMENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLATAFORMAPAGAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLATAFORMAPAGAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLATAFORMAPAGAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLATAFORMAPAGAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLATAFORMAPAGAMENTO actions', async () => {
      const expectedActions = [
        {
