...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './lancamento-carteira-cliente.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LANCAMENTOCARTEIRACLIENTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_LANCAMENTOCARTEIRACLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LANCAMENTOCARTEIRACLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LANCAMENTOCARTEIRACLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LANCAMENTOCARTEIRACLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LANCAMENTOCARTEIRACLIENTE actions', async () => {
      const expectedActions = [
        {
