...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './venda.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VENDA_LIST actions', async () => {
    ...
    it('dispatches FETCH_VENDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VENDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VENDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VENDA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VENDA actions', async () => {
      const expectedActions = [
        {
