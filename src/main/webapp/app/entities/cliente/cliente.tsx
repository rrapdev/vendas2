  ...
  return (
    <div>
      <h2 id="cliente-heading" data-cy="ClienteHeading">
        <Translate contentKey="vendas2App.cliente.home.title">Clientes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="vendas2App.cliente.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/cliente/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="vendas2App.cliente.home.createLabel">Create new Cliente</Translate>
          </Link>
        </div>
      </h2>
        ...
        {clienteList && clienteList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="vendas2App.cliente.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nomeCompleto')}>
                  <Translate contentKey="vendas2App.cliente.nomeCompleto">Nome Completo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('telefone')}>
                  <Translate contentKey="vendas2App.cliente.telefone">Telefone</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('nomeApresentacao')}>
                  <Translate contentKey="vendas2App.cliente.nomeApresentacao">Nome Apresentacao</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('indicadorAtivo')}>
                  <Translate contentKey="vendas2App.cliente.indicadorAtivo">Indicador Ativo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="vendas2App.cliente.carteiraCliente">Carteira Cliente</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {clienteList.map((cliente, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{cliente.nomeApresentacao}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="vendas2App.cliente.home.notFound">No Clientes found</Translate>
            </div>
          )
        )}
      </div>
