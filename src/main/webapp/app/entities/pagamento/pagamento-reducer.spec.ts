...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pagamento.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PAGAMENTO_LIST actions', async () => {
    ...
    it('dispatches FETCH_PAGAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PAGAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PAGAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PAGAMENTO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PAGAMENTO actions', async () => {
      const expectedActions = [
        {
