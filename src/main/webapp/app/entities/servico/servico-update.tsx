  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="vendas2App.servico.home.createOrEditLabel" data-cy="ServicoCreateUpdateHeading">
            <Translate contentKey="vendas2App.servico.home.createOrEditLabel">Create or edit a Servico</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('vendas2App.servico.nomeServico')}
                id="servico-nomeServico"
                name="nomeServico"
                data-cy="nomeServico"
                type="text"
                validate={{
              ...
              />
              <ValidatedField label={translate('vendas2App.servico.valor')} id="servico-valor" name="valor" data-cy="valor" type="text" />
              <ValidatedField
                label={translate('vendas2App.servico.indicadorAtivo')}
                id="servico-indicadorAtivo"
                name="indicadorAtivo"
