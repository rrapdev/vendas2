...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './servico.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SERVICO_LIST actions', async () => {
    ...
    it('dispatches FETCH_SERVICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SERVICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SERVICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SERVICO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SERVICO actions', async () => {
      const expectedActions = [
        {
