...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARTEIRACLIENTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARTEIRACLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARTEIRACLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARTEIRACLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARTEIRACLIENTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARTEIRACLIENTE actions', async () => {
      const expectedActions = [
        {
