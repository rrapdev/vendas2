...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLABORADOR_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLABORADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLABORADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLABORADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLABORADOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLABORADOR actions', async () => {
      const expectedActions = [
        {
